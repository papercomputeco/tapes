...
func (k deckKeyMap) ShortHelp() []key.Binding {
	return []key.Binding{k.Down, k.Up, k.Enter, k.Back, k.Sort, k.Filter, k.Search, k.Period, k.Replay, k.LoadMore, k.Quit}
}
...
func defaultKeyMap() deckKeyMap {
	return deckKeyMap{
		...
		LoadMore: key.NewBinding(key.WithKeys("n", " "), key.WithHelp("n", "more")),
